...
export default function DaysScreens({ navigation }) {
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <Text style={styles.cardText}>Bayram Ve Özel Gün Tarifleri</Text>
          </View>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Doğum Günü Ve Parti Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Piknik Ve Dış Mekan Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Davet Ve Misafir Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Romantik Akşam Yemeği Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
