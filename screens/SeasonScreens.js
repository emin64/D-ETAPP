...
export default function SeasonScreens({ navigation }) {
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <Text style={styles.cardText}>Fırın Yemekleri</Text>
          </View>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Izgara Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Sote Ve Tava Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Buharda Pişirme Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          <Image source={require('../../Beslenme/assets/ilkbahar.jpg')} style={styles.cardImage} />
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Çiğ Yemek Tarifleri</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
