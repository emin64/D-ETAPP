...
export default function SüreScreens({ navigation }) {
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.contentContainer}>
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <Text style={styles.cardText}>Hızlı Ve Kolay Tarifler</Text>
          </View>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Orta Süreli Tarifler</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Uzun Süreli Tarifler</Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
        ...
        <TouchableOpacity style={styles.card} onPress={() => navigation.navigate('Chat3')}>
          ...
          <View style={styles.textOverlay}>
          <Text style={styles.cardText}>Yavaş Pişen Tarifler </Text>
          </View>
          <TouchableOpacity style={styles.historyButton} onPress={() => navigation.navigate('Chat3')}>
            <Icon name="time-outline" size={20} color="white" />
            <Text style={styles.historyText}>Geçmiş</Text>
